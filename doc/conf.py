...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'cgal_meshing') documentation build configuration file, created by
...
project = u'openalea.cgal_meshing'
copyright = u'2015, openalea.cgal_meshing'
...
htmlhelp_basename = 'cgal_meshingdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'cgal_meshing.tex',
     u'cgal_meshing Documentation',
     u'Guillaume Cerutti', 'manual'),
]
...
texinfo_documents = [
    ('index', 'cgal_meshing',
     ...
     u'Guillaume Cerutti',
     'cgal_meshing',
     'Generating coarse meshes of cell tissue from 3D segmented images',
     'Miscellaneous'),
]
