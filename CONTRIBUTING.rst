...
Ready to contribute? Here's how to set up `cgal_meshing` for local development.

1. Fork the `cgal_meshing` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/cgal_meshing.git
...
tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd cgal_meshing
    (dvlpt) cgal_meshing$ flake8
    (dvlpt) cgal_meshing$ nosetests
    (dvlpt) cgal_meshing$ tox
...
3. The pull request should work for Python 2.7, 3.4, and 3.5. Check
   https://travis-ci.org/Guillaume Cerutti/cgal_meshing/pull_requests
...
.. _issues: https://github.com/Guillaume Cerutti/cgal_meshing/issues
